...
1. Open a new terminal window and change your directory to proj1_analysis
...
4. Now you're ready to run the Python file by typing $ python website.py
5. In you're preferred internet browser, go to localhost:4242 to view and use the app.

What comes with my project:

1. The app itself - the website.py file
