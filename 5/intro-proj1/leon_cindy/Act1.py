...
image["Maplehoof"] = "http://fc07.deviantart.net/fs71/f/2012/199/5/8/homestuck_maplehoof_signature_by_roseswan-d57qsws.png"
...
image["Jade"] = "http://static.comicvine.com/uploads/original/13/135699/2627380-Jade.Harley.full.841837.jpg"
...
def createVarChar(name1, name2, name3, name4):
    ...
    for name in namelist:
        ...
        if name == "Jasper":
            namelist[namelist.index(name)] = "Jaspers"
        if name == "Jaspers":
