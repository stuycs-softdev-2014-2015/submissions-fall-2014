...
def decode(s):
    distance = [dist(calcPercents(encode2(s,x)), englishPercents) for x in range(26)]
    return encode2(s,distance.index(min(dis)))
...
s2="the quick brown fox jumped over the lazy dog The Quick Brown Fox Jumped Over The Lazy Dog THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG"
# This is encoded message
encmessage = encode2(s2,random.randrange(26))
print encmessage
