...
print dist(calcPercents(s), englishPercents)
print dist(calcPercents(encmessage), englishPercents)

for x in range(26):
    distance1 = dist(calcPercents(encode2(s,x)),englishPercents)
    distance2 = dist(calcPercents(encmessage),englishPercents)
